...
inpath <- "../Geneva/SEF/5_monthly"
dailypath <- "../Geneva/SEF/4_daily"
refpath <- "../Geneva/SEF/refs"
outpath <- "../Geneva/SEF/6_hom"

target_series <- c("DigiHom_Geneva_1836", "DigiHom_Geneva_1826", "DigiHom_Geneva_1822",
                   "DigiHom_Geneva_1798", "Deluc", "JdG", "Genthod_1796", 
                   "Genthod_1789", "Senebier", "Avully")

ref_series <- c("Delemont", "Solothurn", "Weissenstein", "Vevey",
                "Gottstatt", "Fribourg", "Aarau_Zschogge", "Simler",
                "Neuchatel", "Mulhouse", "Waldenburg", "Schaffhausen",
                "Fontaines", "Morges", "Luzern_Ineichen",
                "Aarau_Bronner", "Zug", "Uetliberg", "Bern_Observatory", "Reinhard", 
                "Burgdorf_1851", "Koch", "Wolf", "Benoit", "Trechsel_1848", "Trechsel_1826", 
                "Studer_1803", "Studer_1801", "Sutz", "Hirzel_1761",
...
breakpoints <- read.csv("../Metadata/Geneva_breakpoints_ta.csv", sep=";", stringsAsFactors=FALSE)
...
## Inizialize list of homogeneous segments
x <- list()
